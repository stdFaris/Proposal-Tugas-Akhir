...
\usepackage[shortlabels]{enumitem} % for customizing 
...
\begin{center}
    ...
    {\Large\bfseries IMPLEMENTASI \textit{OPTICAL CHARACTER RECOGNITION} DENGAN ANALISIS TATA LETAK UNTUK REKONTRUKSI DOKUMEN}\\
     \vspace{3cm}
